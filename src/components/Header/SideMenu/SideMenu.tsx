...
function SideMenu({sideMenu, setSideMenu}: Props) {
    ...
    return (
        <>
            {sideMenu && <div className=" absolute top-0 right-0 bottom-0 w-full h-[100vh] bg-[rgba(0,0,0,.3)] z-[60]"></div>}
            <div className={" w-[280px] h-full font-medium bg-white shadow-md py-[30px] px-[20px] duration-300 top-0 fixed z-[70] " + (sideMenu ? ' left-0' : '-left-[280px]')}>
                ...
                <div className=" flex flex-col pt-[50px] pb-[35px] pr-[10px]">
                    <Link onClick={() => setSideMenu(false)} to={'/'} className=" flex items-center justify-between py-[10px]">
                        <p className=" text-sm duration-300 hover:text-primary-100">Trang chủ</p>
                    </Link>
                    <Link onClick={() => setSideMenu(false)} to={'/job-listing'} className=" flex items-center justify-between py-[10px] duration-300">
                        <p className=" text-sm duration-300 hover:text-primary-100">Tìm việc</p>
                    </Link>
                    <Link onClick={() => setSideMenu(false)} to={'/company-listing'} className=" flex items-center justify-between py-[10px] duration-300">
                        <p className=" text-sm duration-300 hover:text-primary-100">Tìm công ty</p>
                    </Link>
                    <Link onClick={() => setSideMenu(false)} to={'/contact'} className=" flex items-center justify-between py-[10px]">
                        <p className=" text-sm duration-300 hover:text-primary-100">Liên hệ</p>
                    </Link>
                </div>
                <div>
                    <Link onClick={() => setSideMenu(false)} to={'/login'} className=" flex items-center justify-center w-full border border-[#dfe9e5] rounded-[5px] py-[9px] mb-[25px] duration-300 hover:bg-primary-100">
                        <User />
                    ...
                    {dropDownSignup && (
                        <div className=" w-full bg-white shadow-md rounded-md p-2">
                            <Link to={'/register/jobseeker'} onClick={() => {setDropDownSignup(false); setSideMenu(false)}} className=" flex items-center w-full bg-gray-200 rounded-md px-3 py-2 mb-2 duration-200 cursor-pointer hover:bg-gray-300">
                            ...
                            <Link to={'/register/company'} onClick={() => {setDropDownSignup(false); setSideMenu(false)}} className=" flex items-center w-full bg-gray-200 rounded-md px-3 py-2 duration-200 cursor-pointer hover:bg-gray-300">
